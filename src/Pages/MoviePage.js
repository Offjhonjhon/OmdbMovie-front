...
import imdbLogo from '../assets/imdb-logo-2016-1.svg';
import metacriticLogo from '../assets/metacritic.svg';
import rottenTomatoesLogo from '../assets/rotten.svg';
    ...
    <MoviePageContainer>
      <MoviePageInfo>
        <MovieInfo>
          ...
          <RatedIcon>{movie.Rated}</RatedIcon>
        </MovieInfo>
        ...
        <MoviePageCastInformation>
          <MovieCast>
            ...
            {movie.Actors.split(', ').map((actor) => {
              return <Item key={actor}>{actor}</Item>;
            })}
          </MovieCast>
          <MovieGenre>
            <BoxTittle>Genre</BoxTittle>
            {movie.Genre.split(', ').map((genre) => {
              return <Item key={genre}>{genre}</Item>;
            })}
          </MovieGenre>
          <MovieDirector>
